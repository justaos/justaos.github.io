import { r as registerInstance, h, a as getAssetPath, H as Host, g as getElement, c as createEvent } from './index-6bad8be4.js';
import { g as getComponentIndex } from './utils-02ac3efa.js';
...
const EmptyState = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: { 'empty-state': true, 'vertical': this.vertical } }, h("div", { class: 'illustration' }, h("goat-svg", { src: getAssetPath(`./assets/images/empty-state/${this.illustration}.svg`) })), h("div", { class: 'content' }, this.headline && h("div", { class: 'title' }, this.headline), this.description && h("div", { class: 'description', innerHTML: purify.sanitize(this.description) }), h("div", { class: 'actions' }, this.action &&
...
export { EmptyState as goat_empty_state, Menu as goat_menu, GoatMenu as goat_menu_item, Text as goat_text };

//# sourceMappingURL=goat-empty-state_4.entry.js.map