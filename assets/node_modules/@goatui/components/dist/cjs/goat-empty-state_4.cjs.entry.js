...
const EmptyState = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { 'empty-state': true, 'vertical': this.vertical } }, index.h("div", { class: 'illustration' }, index.h("goat-svg", { src: index.getAssetPath(`./assets/images/empty-state/${this.illustration}.svg`) })), index.h("div", { class: 'content' }, this.headline && index.h("div", { class: 'title' }, this.headline), this.description && index.h("div", { class: 'description', innerHTML: purify.sanitize(this.description) }), index.h("div", { class: 'actions' }, this.action &&
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.internalEmptyState = undefined;
  }
  parseEmptyState() {
...
//# sourceMappingURL=goat-empty-state_4.cjs.entry.js.map