...
async function loadPrism() {
  // @ts-ignore
  await utils.loadScript(`https://cdnjs.cloudflare.com/ajax/libs/prism/${PRISM_VERSION}/components/prism-core.min.js`);
  await utils.loadScript(`https://cdnjs.cloudflare.com/ajax/libs/prism/${PRISM_VERSION}/plugins/autoloader/prism-autoloader.min.js`);
}
...
const CodeHighlighter = class {
  ...
  render() {
    return (index.h(index.Host, null, this.compiledCode && index.h("div", { class: 'code-highlighter' }, index.h("div", { class: 'scroll-wrapper' }, index.h("div", { class: { 'line-numbers-wrapper': true, 'line-numbers': this.lineNumbers } }, index.h("pre", { dir: 'ltr', class: 'highlighter line-numbers', innerHTML: this.compiledCode }))), index.h("goat-button", { class: 'copy-btn color-secondary icon-only', size: 'sm', variant: 'ghost', "aria-label": 'Copy code', title: 'Copy code', "onGoat:click": () => {
      ...
      } }, index.h("goat-icon", { name: 'files', size: '1rem' }))), !this.compiledCode && index.h("div", { class: 'code-loader' }, index.h("goat-spinner", { class: 'rainbow' }), "Loading code...")));
  }
