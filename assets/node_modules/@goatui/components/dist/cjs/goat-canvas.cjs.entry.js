...
const Canvas = class {
  ...
  render() {
    ...
    return index.h(index.Host, null, index.h("div", { class: 'canvas-wrapper', style: {
      ...
      } }, index.h("svg", { class: 'canvas', height: `100%`, width: `100%`, viewBox: `${this.computedViewbox.x * this.unitSize} ${this.computedViewbox.x * this.unitSize} ${this.computedViewbox.width * this.unitSize} ${this.computedViewbox.height * this.unitSize}` }, (this.paths.map((path) => {
