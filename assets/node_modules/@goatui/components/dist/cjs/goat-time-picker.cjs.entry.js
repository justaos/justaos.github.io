...
const TimePicker = class {
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, "has-value": this.hasValue() }, index.h("div", { class: {
      ...
      } }, index.h("input", { type: 'time', tabindex: this.tabindex, class: 'input input-native', disabled: this.disabled, readOnly: this.readonly, onKeyDown: this.keyDownHandler, onInput: this.inputHandler, onBlur: this.blurHandler, onFocus: this.focusHandler }))));
  }
  get elm() { return index.getElement(this); }
};
TimePicker.style = timePickerCss;

exports.goat_time_picker = TimePicker;

//# sourceMappingURL=goat-time-picker.cjs.entry.js.map