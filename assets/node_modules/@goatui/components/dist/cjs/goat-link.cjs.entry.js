...
const Link = class {
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, active: this.isActive }, index.h("a", { class: {
        'link': true,
        'has-focus': this.hasFocus,
        'active': this.isActive,
      }, href: this.href, target: this.target, itemprop: this.itemprop, ref: input => this.nativeInput = input, tabindex: this.tabindex, onBlur: this.blurHandler, onFocus: this.focusHandler, onMouseDown: this.mouseDownHandler, onKeyDown: this.keyDownHandler }, index.h("slot", null))));
  }
  get elm() { return index.getElement(this); }
};
Link.style = linkCss;

exports.goat_link = Link;

//# sourceMappingURL=goat-link.cjs.entry.js.map