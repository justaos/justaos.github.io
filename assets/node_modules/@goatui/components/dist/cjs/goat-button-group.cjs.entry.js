...
const ButtonGroup = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: 'button-group' }, index.h("slot", null))));
  }
};
ButtonGroup.style = buttonGroupCss;

exports.goat_button_group = ButtonGroup;

//# sourceMappingURL=goat-button-group.cjs.entry.js.map