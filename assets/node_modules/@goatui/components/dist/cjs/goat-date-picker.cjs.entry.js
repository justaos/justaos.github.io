...
const DatePicker = class {
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, "has-value": this.hasValue() }, index.h("div", { class: {
      ...
      } }, index.h("input", { type: 'date', tabindex: this.tabindex, class: 'input input-native', disabled: this.disabled, readonly: this.readonly, onKeyDown: this.keyDownHandler, onInput: this.inputHandler, onBlur: this.blurHandler, onFocus: this.focusHandler }))));
  }
  get elm() { return index.getElement(this); }
};
DatePicker.style = datePickerCss;

exports.goat_date_picker = DatePicker;

//# sourceMappingURL=goat-date-picker.cjs.entry.js.map