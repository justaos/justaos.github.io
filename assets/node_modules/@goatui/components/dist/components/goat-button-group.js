...
function defineCustomElement$1() {
  ...
  const components = ["goat-button-group"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-button-group":
...
const GoatButtonGroup = ButtonGroup;
const defineCustomElement = defineCustomElement$1;

export { GoatButtonGroup, defineCustomElement };

//# sourceMappingURL=goat-button-group.js.map