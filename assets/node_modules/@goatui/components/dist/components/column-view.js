...
import { r as requiredArgs, t as toDate, s as startOfDay, i as isEqual, d as defineCustomElement$1 } from './column-view-background.js';
...
const CalendarColumnView = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get elm() { return this; }
  static get style() { return columnViewCss; }
}, [1, "goat-calendar-column-view", {
    "events": [16],
    "view": [1],
    "days": [2],
    "currentTime": [16],
...
function defineCustomElement() {
  ...
  const components = ["goat-calendar-column-view", "goat-calendar-column-view-background"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-calendar-column-view":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CalendarColumnView);
      }
      break;
...
export { CalendarColumnView as C, addDays as a, defineCustomElement as d, format as f };
