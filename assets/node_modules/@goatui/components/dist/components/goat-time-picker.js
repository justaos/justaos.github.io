...
const TimePicker = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    return (h(Host, { "has-focus": this.hasFocus, "has-value": this.hasValue() }, h("div", { class: {
      ...
      } }, h("input", { type: 'time', tabindex: this.tabindex, class: 'input input-native', disabled: this.disabled, readOnly: this.readonly, onKeyDown: this.keyDownHandler, onInput: this.inputHandler, onBlur: this.blurHandler, onFocus: this.focusHandler }))));
  }
  get elm() { return this; }
...
function defineCustomElement$1() {
  ...
  const components = ["goat-time-picker"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-time-picker":
...
const GoatTimePicker = TimePicker;
const defineCustomElement = defineCustomElement$1;

export { GoatTimePicker, defineCustomElement };

//# sourceMappingURL=goat-time-picker.js.map