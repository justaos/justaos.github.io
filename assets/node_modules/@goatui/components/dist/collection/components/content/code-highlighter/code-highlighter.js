  ...
  render() {
    return (h(Host, null,
      this.compiledCode && h("div", { class: 'code-highlighter' },
        ...
        h("goat-button", { class: 'copy-btn color-secondary icon-only', size: 'sm', variant: 'ghost', "aria-label": 'Copy code', title: 'Copy code', "onGoat:click": () => {
            this.handleCopyClick();
          } },
          h("goat-icon", { name: 'files', size: '1rem' }))),
