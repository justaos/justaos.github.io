...
export class Spinner {
    ...
    return (h(Host, null,
      h("div", { class: 'spinner' },
        h("svg", { version: '1.1', class: 'loader icon-svg', x: '0px', y: '0px', width: this.getSize(), height: this.getSize(), viewBox: '0 0 50 50', fill: 'currentColor' },
          h("path", { d: 'M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z' },
  ...
  static get is() { return "goat-spinner"; }
