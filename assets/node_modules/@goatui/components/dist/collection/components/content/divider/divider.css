...
.divider:not(.vertical) .line {
  width: 100%;
  border-top: 1px solid var(--border-color, var(--color-gray-50, #8d8d8d));
}
.divider:not(.vertical).has-content .slot-container {
...
.divider.vertical .line {
  height: 100%;
  border-right: 1px solid var(--border-color, var(--color-gray-50, #8d8d8d));
}
.divider.vertical.has-content .slot-container {
