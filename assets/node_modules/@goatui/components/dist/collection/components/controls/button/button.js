  ...
  static get methods() {
    return {
      "setFocus": {
        ...
        "docs": {
          "text": "Sets focus on the native `button` in `goat-button`. Use this method instead of the global\n`button.focus()`.",
          "tags": []
        }
      },
      "setBlur": {
        ...
        "docs": {
          "text": "Sets blur on the native `button` in `goat-button`. Use this method instead of the global\n`button.blur()`.",
          "tags": []
        }
      },
      "triggerClick": {
