  ...
  static get methods() {
    return {
      "setFocus": {
        ...
        "docs": {
          "text": "Sets focus on the native `textarea` in `goat-textarea`. Use this method instead of the global\n`textarea.focus()`.",
          "tags": []
        }
      },
      "setBlur": {
        ...
        "docs": {
          "text": "Sets blur on the native `textarea` in `goat-textarea`. Use this method instead of the global\n`textarea.blur()`.",
          "tags": []
        }
      },
      "getComponentId": {
